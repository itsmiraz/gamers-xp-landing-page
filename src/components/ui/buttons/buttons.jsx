...
export const SecondaryButton = ({ children }) => {
    return <button className="relative text-white font-red-hat-display uppercase font-bold text-[14px] md:text-[20px] px-6 py-4 h-fit w-fit bg-gradient-to-r from-[#000000]/50 to-[#000000]/0">

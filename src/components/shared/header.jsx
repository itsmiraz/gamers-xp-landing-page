...
const Header = () => {
    ...
    return (
        <div className='z-50 fixed w-[100%]  bg-black top-0 left-1/2 transform -translate-x-1/2 max-w-[1920px] mx-auto flex justify-between items-center py-4 px-4 md:px-10' >
            ...
            <ul className={` lg:static overflow-y-visible max-h-screen absolute ${!Open ? "top-0" : "-top-[1000px]"} left-0 px-4 md:px-10 lg:px-0 justify-start bg-black lg:bg-transparent w-full lg:w-fit ease-in-out transition-all duration-300  pt-20 lg:pt-0 pb-10 lg:pb-0 z-40  lg:flex lg:space-y-0 space-y-4  gap-x-4 `}>
                {
